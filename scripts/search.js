$(document).ready(function () {
    const animes = [
        ...
        // Comedia
        { title: "Gintama", genre: "comedia", status: "emision", url: "gintama.html" },
        { title: "Nichijou", genre: "comedia", status: "emision", url: "nichijou.html" },
        { title: "KonoSuba", genre: "comedia", status: "emision", url: "konosuba.html" },
        { title: "Saiki Kusuo no Psi-nan", genre: "comedia", status: "emision", url: "saiki-kusuo.html" },
        { title: "Grand Blue", genre: "comedia", status: "emision", url: "grand-blue.html" },
        ...
        { title: "Naruto", genre: "aventura", status: "emision", url: "naruto.html" },
        { title: "Attack on Titan", genre: "aventura", status: "emision", url: "attack-on-titan.html" },
        { title: "Fullmetal Alchemist: Brotherhood", genre: "aventura", status: "emision", url: "fullmetal-alchemist.html" },
        ...
        { title: "Vinland Saga", genre: "aventura", status: "emision", url: "vinland-saga.html" },
        { title: "Re:Zero", genre: "aventura", status: "emision", url: "re-zero.html" },
        { title: "Sword Art Online", genre: "aventura", status: "emision", url: "sword-art-online.html" },
